...
async function createRecord() {
	...
	return await axios({
		method: "post",
		url: `https://${orgId}.my.salesforce.com/services/data/v56.0/sobjects/[Object]/`,
		headers: {
...
async function updateRecord(id, fieldName, fieldValue) {
	...
	return await axios({
		method: "patch",
		url: `https://${orgId}.my.salesforce.com/services/data/v56.0/sobjects/[Object]/${id}`,
		headers: {
			Authorization: `Bearer ${access_token}`,
		},
		data: {
...
async function queryData(query) {
	...
	return await axios({
		method: "GET",
		url: `https://${orgId}.my.salesforce.com/services/data/v56.0/query?q=${query}`,
		headers: {
			Authorization: `Bearer ${access_token}`,
		},
	});
...
async function parameterizedQuery(wordToSearch, objName) {
	...
	return await axios({
		method: "POST",
		url: `https://${orgId}.my.salesforce.com/services/data/v45.0/parameterizedSearch`,
		headers: {
			Authorization: `Bearer ${access_token}`,
		},
		data: {
